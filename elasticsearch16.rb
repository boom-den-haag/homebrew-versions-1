class Elasticsearch16 < Formula
  desc "Distributed search & analytics engine"
  homepage "https://www.elastic.co/products/elasticsearch"
  url "https://download.elastic.co/elasticsearch/elasticsearch/elasticsearch-1.6.2.tar.gz"
  sha256 "b7ef3aae0a263c2312bd1a25b191c3c108c92d5413c3527d776587e582c518d0"
  ...
  plist_options :manual => "elasticsearch --config=#{HOMEBREW_PREFIX}/opt/elasticsearch16/config/elasticsearch.yml"
  ...
  def plist; <<-EOS.undent
      ...
      <plist version="1.0">
        <dict>
          ...
          <string>#{var}/log/elasticsearch16.log</string>
